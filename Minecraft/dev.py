...
txt = Text(text="DEV version", color=color.black, scale=1, x=-0.86, y=0.48)
...
def input(bk):
    ...
    ui = Entity(parent = camera.ui,model = 'quad', scale = 0.1, texture = 'blocks/border.png')
    if bk == 2:
...
#ui = Entity(
#    parent = camera.ui,model = 'blocks/block', scale = 0.05, texture = grass, position = (-0.3,-0.42))
#ui = Entity(
#    parent = camera.ui,model = 'blocks/block', scale = 0.05, texture = dirt, position = (-0.1,-0.42))
#ui = Entity(
#    parent = camera.ui,model = 'blocks/block', scale = 0.05, texture = stone, position = (0.1,-0.42))
#ui = Entity(
#    parent = camera.ui,model = 'blocks/block', scale = 0.05, texture = brick, position = (0.3,-0.42))


#block ='1'
#def input(block):
#    if block == '1':
#        ui1 = Entity(   parent = camera.ui,model = 'cube', texture = 'blocks/border.png', scale = 0.15, position = (-0.3,-0.42))
#    elif block == '2':
#        ui1 = Entity(   parent = camera.ui,model = 'cube', texture = 'blocks/border.png', scale = 0.15, position = (-0.1,-0.42))
#    elif block == '3':
#        ui1 = Entity(   parent = camera.ui,model = 'cube', texture = 'blocks/border.png', scale = 0.15, position = (0.1,-0.42))
#    elif block == '4':
#        ui1 = Entity(   parent = camera.ui,model = 'cube', texture = 'blocks/border.png', scale = 0.15, position = (0.3,-0.42))
